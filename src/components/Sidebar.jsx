...
import { LayoutDashboard, List, Settings, LogOut, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    return (
        <aside className={`${isCollapsed ? 'w-16' : 'w-64'} bg-slate-900 min-h-screen text-slate-300 flex flex-col shadow-xl flex-shrink-0 transition-all duration-300`}>
            ...
            <div className="p-4 border-t border-slate-800">
                ...
                <button className={`flex items-center ${isCollapsed ? 'justify-center' : 'gap-3'} px-3 py-2.5 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800 w-full transition-colors`}>
